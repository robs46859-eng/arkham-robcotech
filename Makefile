...
# Scenario 5 Testing
test-scenario-5:
	@echo "Running Scenario 5: Cross-Vertical Lead Routing tests..."
	python3 tests/scenario_5_test.py

# Media-to-Commerce Testing
test-media-commerce:
	@echo "Running Media-to-Commerce loop tests..."
	python3 tests/media_to_commerce_test.py

# Run all tests
test-all: test test-e2e test-scenario-5 test-media-commerce
